...
<head>
    ...
    <meta name="description" content="Dashboard Management">
        ...
        <div class="app-auth-container">
            ...
            <form action="" method="post" onsubmit="return doLogin()">
                <div class="auth-credentials m-b-xxl">
                    <label for="signInUsername" class="form-label">Username / Email / No. HP</label>
                    <input type="text" class="form-control m-b-md" id="signInUsername" aria-describedby="signInUsername" placeholder="example@neptune.com">
